...
export function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="section-hero animated-bg py-32 px-4 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="inline-block mb-6 px-4 py-2 bg-[#efe5da]/80 backdrop-blur-sm rounded-full border border-wood/30 shadow-soft">
            <span className="text-sm font-semibold text-ink">🔷 Powered by AI</span>
          </div>

          <h1 className="text-6xl md:text-8xl font-extrabold mb-6 text-ink leading-tight tracking-tight font-serif">
            Discover Your Next
            <br />
          ...
          <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto text-muted leading-relaxed">
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="glass-dark rounded-2xl p-6">
              <div className="text-4xl font-bold text-ink mb-2">50,000+</div>
              <div className="text-muted">Happy Readers</div>
            </div>
            <div className="glass-dark rounded-2xl p-6">
              <div className="text-4xl font-bold text-ink mb-2">98%</div>
      ...
      <section className="section-hero animated-bg py-32 px-4 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          <h2 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight text-ink font-serif">
            Ready to Start Your
            <br />
            <span className="gradient-text">
              Reading Journey?
